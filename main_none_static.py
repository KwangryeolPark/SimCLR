...
def main(gpu, args):
    ...
    if args.reload:
        model_fp = os.path.join(
            args.model_path, "checkpoint_{}_{}_{}.tar".format(args.pretrained_dataset, "static" if args.save_static else "none_static", args.epoch_num)
        )
...
if __name__ == "__main__":
    ...
    wandb.init(
        project='SCL',
        tags=['original_code', 'pretrain', 'none_static'],
